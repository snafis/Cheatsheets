...
`LaTeX math mode` _is the math mode of LaTex. Where LaTeX is an advanced markup language used for typesetting.
...
* [MathJax reference](http://docs.mathjax.org/en/latest/input/tex/macros/index.html) 
